...
export default {
  ...
  args: {
    ...
    accounts:[
      {address:'0x5Ab19e7091dD208F352F8E727B6DCC6F8aBB6275',id:'cf8dace4-9439-4bd4-b3a8-88c821c8fcb3',metadata:{name:'Custody Account A',keyring:{type:'Custody'}},options:{},scopes:['eip155:0'],type:'eip155:eoa'},
],
selectedAccounts:[]
}
}
